...
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://USER:PASSWORD@URL_BASE_DE_DATOS/NOMBRE_BASE_DE_DATOS'
...
class Producto(db.Model):   # la clase Producto hereda de db.Model
    ...
    nombre=db.Column(db.String(99))
    descripcion=db.Column(db.String(999))
    imagen=db.Column(db.String(999))
